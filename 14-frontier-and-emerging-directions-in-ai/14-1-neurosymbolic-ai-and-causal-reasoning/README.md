...
- Explain where neurosymbolic methods outperform purely neural approaches.
- Distinguish correlation from causation in model interpretation.
- Simulate basic interventions and rule-constrained behavior.
